...
> __Keywords__          Google Play Games Services, game network, gpgs, real-time, sendReliably, participantId
...
[String][api.type.String] representing the participant&nbsp;ID of the peer to whom the message was sent.