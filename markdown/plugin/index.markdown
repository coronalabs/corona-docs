...
.category-header {
    ...
    height: 42px;
    overflow: hidden;
    background: -moz-linear-gradient( left, #eef2f8 0%, #fff 100% );
    background: -webkit-linear-gradient( left, #eef2f8 0%, #fff 100% );
    background: linear-gradient( to right, #eef2f8 0%, #fff 100% );
    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr="#eef2f8", endColorstr="#fff", GradientType=1 );
}
.category-tile {
    width: 42px;
    height: 42px;
...
.section .level2 h2, .section .level2 h4 {
    display: none;
}
...
<!---
* [GameAnalytics](https://github.com/GameAnalytics/GA-SDK-CORONA/wiki)
* [TUNE](https://developers.tune.com/sdk/corona-plugin-quick-start/)
-->
...
* [Google Play Games Services][plugin.gpgs3]
...
<!---
* [OneSignal](https://documentation.onesignal.com/docs/corona-sdk)
* [PlayFab](https://github.com/PlayFab/LuaSdk/blob/master/Corona/README.md)
-->
...
<!--- THIS SECTION IS NECESSARY FOR LEFT-COLUMN INDEX --->
